...
// User prompted to continue, choosing numbers, letters, etc.
    ...
    var confirmLower = confirm("Would you like to use lowercase letters?");
      if (confirmLower) {
      confirm("Your password will contain a lower case letter");
    } else {
    ...
    var confirmUpper = confirm("Would you like to use upper case letters?");
      if (confirmUpper) {
      confirm("Your password will contain an upper case letter.");
    } else {
      confirm("Your password will not contain an upper case letter.");
     }
